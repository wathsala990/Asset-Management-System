...
public class M_D_InvoiceController {
    // Direct mapping to serve Invoice/director/Invoice.html at /Invoice/director/Invoice
    @GetMapping("/Invoice/director/Invoice")
    public String serveDirectorInvoiceDirect() {
        return "Invoice/director/Invoice";
    }
    // Redirect /directorInvoice to /director/directorInvoice
    @GetMapping("/directorInvoice")
    public String redirectToDirectorInvoice() {
        return "redirect:/director/directorInvoice";
    }
